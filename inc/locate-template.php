 ...
 * @param string $default_path      Default path to template files.
 */
function bs_preloader_get_template($template_name, $args = array(), $template_path = '', $default_path = '') {

  if (is_array($args) && isset($args)) :
    extract($args);
  endif;

  $template_file = bs_preloader_locate_template($template_name, $template_path, $default_path);
